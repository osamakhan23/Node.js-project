document.addEventListener("DOMContentLoaded", function () {
  ...
  searchForm.addEventListener("submit", function (event) {
    ...
    const searchYearStart = document.getElementById("searchYearStart").value;
    const searchYearEnd = document.getElementById("searchYearEnd").value;

    // Construct the URL based on your server-side API
    const url = `/cars/year?yearStart=${searchYearStart}&yearEnd=${searchYearEnd}`;
