document.addEventListener("DOMContentLoaded", function () {
  ...
  searchForm.addEventListener("submit", function (event) {
    ...
    const searchOdometerLower = document.getElementById(
      "searchOdometerLower"
    ).value;
    const searchOdometerUpper = document.getElementById(
      "searchOdometerUpper"
    ).value;

    // Construct the URL based on your server-side API
    const url = `/cars/odometer?minOdometer=${searchOdometerLower}&maxOdometer=${searchOdometerUpper}`;
